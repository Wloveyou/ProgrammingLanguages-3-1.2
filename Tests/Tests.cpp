...
namespace Tests
{
	...
	public:
		...
		{
			// arrange
			Matrix matrix_1 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
			Matrix matrix_2 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
		...
		TEST_METHOD(Matrix_Transpose_ValidData_Success)
		{
			// arrange
			Matrix matrix_1 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 8, 9 });
			Matrix transposed = Matrix(3, 3, { 1, 4, 7, 2, 5, 8, 3, 6, 9 });
		...
		{
			// arrange
			Matrix matrix_1 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 4, 9 });
			std::vector<int> row{ 1,1,1 };
			Matrix result = Matrix(4, 3, { 1, 2, 3, 4, 5, 6, 7, 4, 9, 1, 1, 1 });
		...
		TEST_METHOD(Matrix_AddRowIndex_ValidData_Success)
		{
			...
			Matrix matrix_1 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 4, 9 });
			std::vector<int> row{ 1,1,1 };
			Matrix result = Matrix(4, 3, { 1, 1, 1, 1, 2, 3, 4, 5, 6, 7, 4, 9});
		...
		TEST_METHOD(Matrix_AddColumn_ValidData_Success)
		{
			...
			Matrix result = Matrix(3, 4, { 1, 2, 3, 1, 4, 5, 6, 1, 7, 4, 9, 1 });
		...
		TEST_METHOD(Matrix_AddColumnIndex_ValidData_Success)
		{
			...
			Matrix matrix_1 = Matrix(3, 3, { 1, 2, 3, 4, 5, 6, 7, 4, 9 });
			std::vector<int> column{ 1,1,1 };
			Matrix result = Matrix(3, 4, { 1, 1, 2, 3, 1, 4, 5, 6, 1, 7, 4, 9 });
